...
//go:generate minimock -i github.com/vestamart/homework/pkg/api/loms/v1.LomsClient -o loms_client_mock.go -n LomsClientMock -p mock
...
import (
	...
	mm_loms "github.com/vestamart/homework/pkg/api/loms/v1"
...
type LomsClientMock struct {
	...
	funcOrderCancel          func(ctx context.Context, in *mm_loms.OrderCancelRequest, opts ...grpc.CallOption) (op1 *mm_loms.OrderCancelResponse, err error)
	...
	funcOrderPay          func(ctx context.Context, in *mm_loms.OrderPayRequest, opts ...grpc.CallOption) (op1 *mm_loms.OrderPayResponse, err error)
...
type LomsClientMockOrderCancelResults struct {
	op1 *mm_loms.OrderCancelResponse
	err error
}
...
func (mmOrderCancel *mLomsClientMockOrderCancel) Return(op1 *mm_loms.OrderCancelResponse, err error) *LomsClientMock {
	if mmOrderCancel.mock.funcOrderCancel != nil {
		mmOrderCancel.mock.t.Fatalf("LomsClientMock.OrderCancel mock is already set by Set")
	}
	...
	mmOrderCancel.defaultExpectation.results = &LomsClientMockOrderCancelResults{op1, err}
...
func (mmOrderCancel *mLomsClientMockOrderCancel) Set(f func(ctx context.Context, in *mm_loms.OrderCancelRequest, opts ...grpc.CallOption) (op1 *mm_loms.OrderCancelResponse, err error)) *LomsClientMock {
	if mmOrderCancel.defaultExpectation != nil {
...
func (e *LomsClientMockOrderCancelExpectation) Then(op1 *mm_loms.OrderCancelResponse, err error) *LomsClientMock {
	e.results = &LomsClientMockOrderCancelResults{op1, err}
	return e.mock
}
...
func (mmOrderCancel *LomsClientMock) OrderCancel(ctx context.Context, in *mm_loms.OrderCancelRequest, opts ...grpc.CallOption) (op1 *mm_loms.OrderCancelResponse, err error) {
...
func (mmOrderPay *mLomsClientMockOrderPay) Return(op1 *mm_loms.OrderPayResponse, err error) *LomsClientMock {
	if mmOrderPay.mock.funcOrderPay != nil {
		mmOrderPay.mock.t.Fatalf("LomsClientMock.OrderPay mock is already set by Set")
	}
	...
	mmOrderPay.defaultExpectation.results = &LomsClientMockOrderPayResults{op1, err}
...
func (mmOrderPay *mLomsClientMockOrderPay) Set(f func(ctx context.Context, in *mm_loms.OrderPayRequest, opts ...grpc.CallOption) (op1 *mm_loms.OrderPayResponse, err error)) *LomsClientMock {
	if mmOrderPay.defaultExpectation != nil {
...
func (e *LomsClientMockOrderPayExpectation) Then(op1 *mm_loms.OrderPayResponse, err error) *LomsClientMock {
	e.results = &LomsClientMockOrderPayResults{op1, err}
	return e.mock
}
...
func (mmOrderPay *LomsClientMock) OrderPay(ctx context.Context, in *mm_loms.OrderPayRequest, opts ...grpc.CallOption) (op1 *mm_loms.OrderPayResponse, err error) {
