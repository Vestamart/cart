...
//go:generate minimock -i github.com/vestamart/loms/pkg/api/loms/v1.LomsClient -o loms_client_mock.go -n LomsClientMock -p mock
...
import (
	...
	mm_loms "github.com/vestamart/loms/pkg/api/loms/v1"
