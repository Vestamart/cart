...
type ProductServiceMock struct {
	...
	funcExistItem          func(ctx context.Context, sku int64) (err error)
	funcExistItemOrigin    string
	inspectFuncExistItem   func(ctx context.Context, sku int64)
	afterExistItemCounter  uint64
...
func NewProductServiceMock(t minimock.Tester) *ProductServiceMock {
	...
	m.ExistItemMock = mProductServiceMockExistItem{mock: m}
	m.ExistItemMock.callArgs = []*ProductServiceMockExistItemParams{}
...
type mProductServiceMockExistItem struct {
	optional           bool
	mock               *ProductServiceMock
	defaultExpectation *ProductServiceMockExistItemExpectation
	expectations       []*ProductServiceMockExistItemExpectation

	callArgs []*ProductServiceMockExistItemParams
	mutex    sync.RWMutex
...
// ProductServiceMockExistItemExpectation specifies expectation struct of the ProductService.ExistItem
type ProductServiceMockExistItemExpectation struct {
	mock               *ProductServiceMock
	params             *ProductServiceMockExistItemParams
	paramPtrs          *ProductServiceMockExistItemParamPtrs
	expectationOrigins ProductServiceMockExistItemExpectationOrigins
	results            *ProductServiceMockExistItemResults
	returnOrigin       string
	Counter            uint64
}

// ProductServiceMockExistItemParams contains parameters of the ProductService.ExistItem
type ProductServiceMockExistItemParams struct {
	ctx context.Context
	sku int64
}

// ProductServiceMockExistItemParamPtrs contains pointers to parameters of the ProductService.ExistItem
type ProductServiceMockExistItemParamPtrs struct {
	ctx *context.Context
	sku *int64
}

// ProductServiceMockExistItemResults contains results of the ProductService.ExistItem
type ProductServiceMockExistItemResults struct {
	err error
}

// ProductServiceMockExistItemOrigins contains origins of expectations of the ProductService.ExistItem
type ProductServiceMockExistItemExpectationOrigins struct {
	origin    string
	originCtx string
	originSku string
}
...
func (mmExistItem *mProductServiceMockExistItem) Optional() *mProductServiceMockExistItem {
	mmExistItem.optional = true
	return mmExistItem
}

// Expect sets up expected params for ProductService.ExistItem
func (mmExistItem *mProductServiceMockExistItem) Expect(ctx context.Context, sku int64) *mProductServiceMockExistItem {
	if mmExistItem.mock.funcExistItem != nil {
		mmExistItem.mock.t.Fatalf("ProductServiceMock.ExistItem mock is already set by Set")
	}

	if mmExistItem.defaultExpectation == nil {
		mmExistItem.defaultExpectation = &ProductServiceMockExistItemExpectation{}
	}

	if mmExistItem.defaultExpectation.paramPtrs != nil {
		mmExistItem.mock.t.Fatalf("ProductServiceMock.ExistItem mock is already set by ExpectParams functions")
	}

	mmExistItem.defaultExpectation.params = &ProductServiceMockExistItemParams{ctx, sku}
	mmExistItem.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
	for _, e := range mmExistItem.expectations {
		if minimock.Equal(e.params, mmExistItem.defaultExpectation.params) {
			mmExistItem.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmExistItem.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for ProductService.ExistItem
func (mmExistItem *mProductServiceMockExistItem) ExpectCtxParam1(ctx context.Context) *mProductServiceMockExistItem {
	if mmExistItem.mock.funcExistItem != nil {
		mmExistItem.mock.t.Fatalf("ProductServiceMock.ExistItem mock is already set by Set")
	}
	...
	if mmExistItem.defaultExpectation.params != nil {
		mmExistItem.mock.t.Fatalf("ProductServiceMock.ExistItem mock is already set by Expect")
	}

	if mmExistItem.defaultExpectation.paramPtrs == nil {
		mmExistItem.defaultExpectation.paramPtrs = &ProductServiceMockExistItemParamPtrs{}
	}
	mmExistItem.defaultExpectation.paramPtrs.ctx = &ctx
	mmExistItem.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)

	return mmExistItem
}

// ExpectSkuParam2 sets up expected param sku for ProductService.ExistItem
func (mmExistItem *mProductServiceMockExistItem) ExpectSkuParam2(sku int64) *mProductServiceMockExistItem {
	if mmExistItem.mock.funcExistItem != nil {
		mmExistItem.mock.t.Fatalf("ProductServiceMock.ExistItem mock is already set by Set")
	}
	...
	mmExistItem.defaultExpectation.paramPtrs.sku = &sku
	mmExistItem.defaultExpectation.expectationOrigins.originSku = minimock.CallerInfo(1)

	return mmExistItem
}

// Inspect accepts an inspector function that has same arguments as the ProductService.ExistItem
func (mmExistItem *mProductServiceMockExistItem) Inspect(f func(ctx context.Context, sku int64)) *mProductServiceMockExistItem {
	if mmExistItem.mock.inspectFuncExistItem != nil {
		mmExistItem.mock.t.Fatalf("Inspect function is already set for ProductServiceMock.ExistItem")
	}

	mmExistItem.mock.inspectFuncExistItem = f

	return mmExistItem
}

// Return sets up results that will be returned by ProductService.ExistItem
func (mmExistItem *mProductServiceMockExistItem) Return(err error) *ProductServiceMock {
	if mmExistItem.mock.funcExistItem != nil {
		mmExistItem.mock.t.Fatalf("ProductServiceMock.ExistItem mock is already set by Set")
	}

	if mmExistItem.defaultExpectation == nil {
		mmExistItem.defaultExpectation = &ProductServiceMockExistItemExpectation{mock: mmExistItem.mock}
	}
	mmExistItem.defaultExpectation.results = &ProductServiceMockExistItemResults{err}
	mmExistItem.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmExistItem.mock
}

// Set uses given function f to mock the ProductService.ExistItem method
func (mmExistItem *mProductServiceMockExistItem) Set(f func(ctx context.Context, sku int64) (err error)) *ProductServiceMock {
	if mmExistItem.defaultExpectation != nil {
		mmExistItem.mock.t.Fatalf("Default expectation is already set for the ProductService.ExistItem method")
	}

	if len(mmExistItem.expectations) > 0 {
		mmExistItem.mock.t.Fatalf("Some expectations are already set for the ProductService.ExistItem method")
	}

	mmExistItem.mock.funcExistItem = f
	mmExistItem.mock.funcExistItemOrigin = minimock.CallerInfo(1)
	return mmExistItem.mock
}

// When sets expectation for the ProductService.ExistItem which will trigger the result defined by the following
// Then helper
func (mmExistItem *mProductServiceMockExistItem) When(ctx context.Context, sku int64) *ProductServiceMockExistItemExpectation {
	if mmExistItem.mock.funcExistItem != nil {
		mmExistItem.mock.t.Fatalf("ProductServiceMock.ExistItem mock is already set by Set")
	}

	expectation := &ProductServiceMockExistItemExpectation{
		mock:               mmExistItem.mock,
		params:             &ProductServiceMockExistItemParams{ctx, sku},
		expectationOrigins: ProductServiceMockExistItemExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmExistItem.expectations = append(mmExistItem.expectations, expectation)
	return expectation
}

// Then sets up ProductService.ExistItem return parameters for the expectation previously defined by the When method
func (e *ProductServiceMockExistItemExpectation) Then(err error) *ProductServiceMock {
	e.results = &ProductServiceMockExistItemResults{err}
	return e.mock
}

// Times sets number of times ProductService.ExistItem should be invoked
func (mmExistItem *mProductServiceMockExistItem) Times(n uint64) *mProductServiceMockExistItem {
	if n == 0 {
		mmExistItem.mock.t.Fatalf("Times of ProductServiceMock.ExistItem mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmExistItem.expectedInvocations, n)
	mmExistItem.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmExistItem
}

func (mmExistItem *mProductServiceMockExistItem) invocationsDone() bool {
	if len(mmExistItem.expectations) == 0 && mmExistItem.defaultExpectation == nil && mmExistItem.mock.funcExistItem == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmExistItem.mock.afterExistItemCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmExistItem.expectedInvocations)
...
func (mmExistItem *ProductServiceMock) ExistItem(ctx context.Context, sku int64) (err error) {
	...
	mmExistItem.t.Helper()

	if mmExistItem.inspectFuncExistItem != nil {
		mmExistItem.inspectFuncExistItem(ctx, sku)
	}

	mm_params := ProductServiceMockExistItemParams{ctx, sku}

	// Record call args
	mmExistItem.ExistItemMock.mutex.Lock()
	mmExistItem.ExistItemMock.callArgs = append(mmExistItem.ExistItemMock.callArgs, &mm_params)
	mmExistItem.ExistItemMock.mutex.Unlock()

	for _, e := range mmExistItem.ExistItemMock.expectations {
	...
	if mmExistItem.ExistItemMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmExistItem.ExistItemMock.defaultExpectation.Counter, 1)
		mm_want := mmExistItem.ExistItemMock.defaultExpectation.params
		mm_want_ptrs := mmExistItem.ExistItemMock.defaultExpectation.paramPtrs

		mm_got := ProductServiceMockExistItemParams{ctx, sku}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmExistItem.t.Errorf("ProductServiceMock.ExistItem got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmExistItem.ExistItemMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.sku != nil && !minimock.Equal(*mm_want_ptrs.sku, mm_got.sku) {
				mmExistItem.t.Errorf("ProductServiceMock.ExistItem got unexpected parameter sku, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmExistItem.ExistItemMock.defaultExpectation.expectationOrigins.originSku, *mm_want_ptrs.sku, mm_got.sku, minimock.Diff(*mm_want_ptrs.sku, mm_got.sku))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmExistItem.t.Errorf("ProductServiceMock.ExistItem got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmExistItem.ExistItemMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmExistItem.ExistItemMock.defaultExpectation.results
		if mm_results == nil {
			mmExistItem.t.Fatal("No results are set for the ProductServiceMock.ExistItem")
		}
		return (*mm_results).err
	}
	if mmExistItem.funcExistItem != nil {
		return mmExistItem.funcExistItem(ctx, sku)
	}
	mmExistItem.t.Fatalf("Unexpected call to ProductServiceMock.ExistItem. %v %v", ctx, sku)
	return
}

// ExistItemAfterCounter returns a count of finished ProductServiceMock.ExistItem invocations
func (mmExistItem *ProductServiceMock) ExistItemAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmExistItem.afterExistItemCounter)
}

// ExistItemBeforeCounter returns a count of ProductServiceMock.ExistItem invocations
func (mmExistItem *ProductServiceMock) ExistItemBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmExistItem.beforeExistItemCounter)
}

// Calls returns a list of arguments used in each call to ProductServiceMock.ExistItem.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmExistItem *mProductServiceMockExistItem) Calls() []*ProductServiceMockExistItemParams {
	mmExistItem.mutex.RLock()

	argCopy := make([]*ProductServiceMockExistItemParams, len(mmExistItem.callArgs))
	copy(argCopy, mmExistItem.callArgs)

	mmExistItem.mutex.RUnlock()

	return argCopy
}

// MinimockExistItemDone returns true if the count of the ExistItem invocations corresponds
// the number of defined expectations
func (m *ProductServiceMock) MinimockExistItemDone() bool {
	if m.ExistItemMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.ExistItemMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.ExistItemMock.invocationsDone()
}

// MinimockExistItemInspect logs each unmet expectation
func (m *ProductServiceMock) MinimockExistItemInspect() {
	for _, e := range m.ExistItemMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ProductServiceMock.ExistItem at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}

	afterExistItemCounter := mm_atomic.LoadUint64(&m.afterExistItemCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.ExistItemMock.defaultExpectation != nil && afterExistItemCounter < 1 {
		if m.ExistItemMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ProductServiceMock.ExistItem at\n%s", m.ExistItemMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ProductServiceMock.ExistItem at\n%s with params: %#v", m.ExistItemMock.defaultExpectation.expectationOrigins.origin, *m.ExistItemMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcExistItem != nil && afterExistItemCounter < 1 {
		m.t.Errorf("Expected call to ProductServiceMock.ExistItem at\n%s", m.funcExistItemOrigin)
	}

	if !m.ExistItemMock.invocationsDone() && afterExistItemCounter > 0 {
		m.t.Errorf("Expected %d calls to ProductServiceMock.ExistItem at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.ExistItemMock.expectedInvocations), m.ExistItemMock.expectedInvocationsOrigin, afterExistItemCounter)
	}
}
